...
// Simulate page detection logic
$page_found = true; // Set this to true if the page exists
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <form class="d-flex" method="get" action="">
                            <input type="text" class="search-input form-control border-main rounded-0" name="search" placeholder="Search Doctor..." value="<?php echo htmlspecialchars($search_query); ?>">
                            <a href="list_doctor.php" class="clear-search btn btn-sm rounded-0 mr-2 btn-main d-flex align-items-center">
                                x
                            </a>
                    ...
                    <button type="button" class="btn btn-sm btn-main d-flex align-items-center" data-toggle="modal" data-target="#add_doctor">
                    ...
                    <div class="row my-5 d-flex align-items-center h-100">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="card-body text-center">
                                <div class="mt-3 mb-4">
                                    <!-- image profile -->
                                    <img src="<?php echo htmlspecialchars($row['doctor_pic']); ?>"
                                ...
                                <p class="text-secondary small mb-3">
                                    <?php echo $row['street'].', ' . $row['barangay'].', ' . $row['city'].', ' . $row['state'].', ' . $row['zipcode'];?>
                                </p>
                                <a href="view_doctor.php?doctor_id=<?php echo $row['doctor_id'];?>" class="btn btn-main btn-rounded btn-md px-4 mb-4">View</a>
                            </div>
                            </div>
                        </div>
                        <?php
