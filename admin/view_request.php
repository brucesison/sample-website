...
if (isset($_GET['appointment_req_id'])) {
    $request = $functions->getThisRequestAppointment($_GET['appointment_req_id']);
} else {
// redirect
} 
                ...
                <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-light small shadow">
                            <li class="breadcrumb-item"><a class="text-main" href="app_request.php">Appointment Request</a></li>
                                ...
                                <div class="card-body text-center">
                                    <div class="row px-4 d-flex justify-content-between align-items-center">
                                        <div class="col-md-6">
                                            ...
                                            <p class="text-secondary text-left"><span class="font-weight-bold">Appointment Time</span> : <?php echo $request['appointment_time'];?> </p>

                                            <p class="text-secondary text-left"><span class="font-weight-bold">Guardian's Name</span> : 
                                                <a href="view_parent.php?user_id=<?php echo $request['parent_id'];?>" class="text-main" data-toggle="tooltip" data-placement="bottom" title="View parent info">
                                                    <?php echo $request['guardian_name'];?>
                                                </a> 
                                            </p>

                                            <p class="text-secondary text-left"><span class="font-weight-bold">Child's Name</span> :
                                                <a href="view_child.php?child_id=<?php echo $child_id;?>" class="text-main" data-toggle="tooltip" data-placement="bottom" title="View child info">
                                                    <?php echo $child_info['child_name'];?>
                                                </a> 
                                            </p>
                                            
                                            <p class="text-secondary text-left"><span class="font-weight-bold">Reason for visit</span> : <?php echo $request['reason_for_visit'];?> </p>
                                            <button type="submit" class="btn btn-main float-left mr-2" data-toggle="modal" data-target="#app_accept">
                                                <i class="fas fa-fw fa-check mr-1"></i>Accept
                                            </button>
                                            <button type="submit" class="btn btn-danger float-left text-light" data-toggle="modal" data-target="#app_reject">
                                                <i class="fas fa-fw fa-plus rotate-n-20 mr-1"></i>Reject
                                            </button>
