                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <form class="d-flex" method="get" action="">
                            <input type="text" class="search-input form-control border-main rounded-0" name="search" placeholder="Search Parent..." value="<?php echo htmlspecialchars($search_query); ?>">
                            <a href="list_parent.php" class="clear-search btn btn-sm rounded-0 mr-2 btn-main d-flex align-items-center">
                                x
                            </a>
                    ...
                    <button type="button" class="btn btn-sm btn-main d-flex align-items-center" data-toggle="modal" data-target="#add_parent">
                    ...
                    <div class="row my-5 d-flex align-items-center h-100">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="card-body text-center">
                                ...
                                <a href="view_parent.php?user_id=<?php echo $row['user_id'];?>" class="btn btn-main btn-rounded btn-md px-4 mb-4">View</a>
                            </div>
                            </div>
                        </div>
                        <?php
